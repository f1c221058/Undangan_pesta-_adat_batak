...
\usepackage[paperwidth=21cm, paperheight=33cm, margin=0.5cm]{geometry}
...
\definecolor{black}{RGB}{0,0,0}% Custom red color
...
\begin{center}
\color{black} % Set color for the frame
\framebox[\textwidth]{
...
\hfill{{\Large\textbf{\uline{GOKHON DOHOT JOU-JOU}}}}\\
\normalsize
\textbf{\uline{Keluarga S.Manalu/Br.Parhusip S.H. (Ama Jona)}} \\
